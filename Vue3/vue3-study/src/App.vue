<template>
  <div class="todo-container">
    <div class="todo-wrap">
      ...
      <List :todos="todos" :deleteToto="deleteToto" :updateTodo="updateTodo"/>
      <Footer :todos="todos" :checkAll="checkAll" :clearAllCompletdTodos="clearAllCompletdTodos"/>
    </div>
  </div>
</template>
<script lang="ts">
